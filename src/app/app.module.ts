...
@NgModule({
  ...
  declarations: [ AppComponent, SettingsComponent, TimeComponent, StatisticsComponent,TimeRemainingComponent, TimeRemainingCardComponent, CoffeeCounterComponent ],
